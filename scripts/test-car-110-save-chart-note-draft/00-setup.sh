#!/usr/bin/env bash
# Setup: Start a session and initialize a chart note for testing save-draft.
# Outputs the CHART_NOTE_ID for subsequent scripts.
...
echo "  ./01-save-draft-happy.sh ${CHART_NOTE_ID}"
